...
requirement1_label = ttk.Label(add_vector_frame, text="X: ")
requirement2_label = ttk.Label(add_vector_frame, text="Y: ")
...
add_vector_button.grid(column=0, row=2, columnspan=4, sticky="ew", pady=5, padx=10)
