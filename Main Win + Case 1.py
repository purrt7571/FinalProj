...
def case_1():
    ...
    # Tk main window
    root = tk.Tk()
    root.title("Vector Addition - Case 1")
...
main_win = tk.Tk()
main_win.title("Vector Addition Calculator")
main_win.minsize(800, 600)

Case1_but = tk.Button(main_win, text="Case 1", command=case_1)
Case1_but.place(x=400, y=300)
