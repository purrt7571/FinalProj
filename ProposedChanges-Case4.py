...
class Case_2(BaseWindow):
    ...
    def __init__(self, master: tk.Tk, minwidth: int = 1500, minheight: int = 900) -> None:
        ...
        self.missing_vct: np.ndarray = np.array([0,0])
        ...
        ttk.Button(self.resultant_vector_frame, text = "Add Vector", command = self.find_one_missing_vector).grid(column=0, row=3, columnspan=4, sticky="ew", pady=(5,10), padx=10)
